...
Starter **Discord Bot** built with **[Robo.js](https://robojs.dev)** - using **PostgreSQL** for data persistence. Just add your **Postgres** variables to the `.env` file, and you're good to go!
...
```bash
npx create-robo --template discord-bots/postgres-ts --name <project-name>
```
