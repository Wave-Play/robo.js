...
This template is just like **[Starter (TS)](https://robojs.dev/templates/discord-bots/starter-ts)**, but with Docker support. You'll find a `Dockerfile`, `.dockerignore`, and `package.json` scripts for **Docker** use. It's perfect for those who want to containerize their bot for easy deployment.
