...
- [💾 **Download:** Download as a zip file](https://f000.backblazeb2.com/file/robo-templates/discord-bots/mrjawesome-dev-toolkit-js.zip)
...
```bash
npx create-robo --template discord-bots/mrjawesome-dev-toolkit-js --name <project-name>
```
