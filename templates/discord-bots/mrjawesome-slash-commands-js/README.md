...
# Discord Bot - Slash Command Package (JS)

This is the go-to if you are new to development here on Discord. Now optimized for **[Robo.js](https://robojs.dev)**, how awesome is that?
...
- [💾 **Download:** Download as a zip file](https://github.com/Wave-Play/robo.js/raw/refs/heads/main/templates/.raw/mrjawesome-slash-commands-js.zip)
...
```bash
npx create-robo --template discord-bots/mrjawesome-slash-commands-js --name <project-name>
```
