...
<section class="home">
  <h1>Robo.js Web App - SvelteKit Starter - JS</h1>
  ...
  <p class="info">Made with <a href="https://svelte.dev/">SvelteKit</a> and <a href="https://robojs.dev/">Robo.js</a></p>
  <!-- https://docs.roboplay.dev/robojs/flashcore -->
  <p class="info">Counter information is stored inside <a href="https://robojs.dev/robojs/flashcore">Robo.js Flashcore.</a></p>
</section>
