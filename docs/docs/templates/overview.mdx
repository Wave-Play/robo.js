...
<CardContainer>
	<Card
		href="https://github.com/Wave-Play/robo.js/tree/main/templates/discord-activities/music-player-proxy"
...
<CardContainer>
	<Card
		href="https://github.com/Wave-Play/robo.js/tree/main/templates/starter-activity-typescript-tailwind"
		title="🔗 TailwindCSS (TS)"
		description="A basic TypeScript template using Tailwind CSS."
	/>
	<Card
		href="https://github.com/Wave-Play/robo.js/tree/main/templates/starter-activity-typescript-tailwind-shadcn"
