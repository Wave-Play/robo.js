...
<Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/%40robojs/auth" title="🔐 @robojs/auth Docs" description=""/>
<Card href="https://nextjs.org/docs" title="📘 Next.js Documentation" description=""/>
<Card href="https://www.prisma.io/docs" title="🗃️ Prisma Documentation" description=""/>
<Card href="https://robojs.dev/discord" title="✨ Discord Community" description=""/></CardContainer>

##  Getting Started

Create a new project with this template:

<Terminal create>{`--template web-apps/next-auth-ts --name my-awesome-app`}</Terminal>

Navigate to your project:

<Terminal>{`cd my-awesome-app`}</Terminal>
...
<Terminal>{`cp example.env .env`}</Terminal>
...
<Terminal execute>{`prisma migrate dev --name init`}</Terminal>
...
<CardContainer><Card href="/templates/overview" title="📦 Explore Templates" description="Discover more templates for a quick start."/><Card href="https://github.com/Wave-Play/robo.js/tree/main/templates/web-apps/next-auth-ts" title="🔗 GitHub Repository" description="Explore source code on GitHub."/></CardContainer>
