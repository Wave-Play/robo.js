...
<Card href="https://f000.backblazeb2.com/file/robo-templates/discord-bots/mrjawesome-dev-toolkit-js.zip" title="💾 Download" description="Download as a zip file"/>
...
<Terminal create>{`--template discord-bots/mrjawesome-dev-toolkit-js --name <project-name>`}</Terminal>
