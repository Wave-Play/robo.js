...
<Card href="https://github.com/Wave-Play/robo.js/raw/refs/heads/main/templates/.raw/mrjawesome-dev-toolkit-js.zip" title="💾 Download" description="Download as a zip file"/>
...
<Terminal create>{`<project-name> --template discord-bots/mrjawesome-dev-toolkit-js`}</Terminal>
