...
<Card href="https://f000.backblazeb2.com/file/robo-templates/discord-bots/mrjawesome-dev-toolkit-ts.zip" title="💾 Download" description="Download as a zip file"/>
...
<Terminal create>{`--template discord-bots/mrjawesome-dev-toolkit-ts --name <project-name>`}</Terminal>
