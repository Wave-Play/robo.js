...
Instead, it simplifies the process of building Discord bots by managing boilerplate code. You still have the full Discord.js API and existing code is still compatible!
