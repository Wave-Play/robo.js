...
The `` object also lets you customize stuff like locale translations, Sage options, and command timeouts. To understand more about the available uration options, check out the [configuration section](/robojs/configuration).
...
Want to explore more options? Check the [configuration section](/robojs/configuration).
