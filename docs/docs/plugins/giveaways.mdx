...
<Terminal execute>{`robo add @robojs/giveaways`}</Terminal>

New to **[Robo.js](https://robojs.dev)**? Start your project with this plugin pre-installed:

<Terminal create>{`<project-name> -p @robojs/giveaways`}</Terminal>
...
<Terminal>{`curl http://localhost:3000/api/giveaways/123456789012345678`}</Terminal>
...
<Terminal>{`curl http://localhost:3000/api/giveaways/123456789012345678/giveaway/01HQRS5F1GZ9J3YF7WXT7H2K2B`}</Terminal>
...
<Terminal>{`curl -X PATCH \
  -H 'Content-Type: application/json' \
  -d '{"action":"reroll","count":2}' \
  http://localhost:3000/api/giveaways/123456789012345678/giveaway/01HQRS5F1GZ9J3YF7WXT7H2K2B`}</Terminal>
...
<Terminal>{`curl http://localhost:3000/api/giveaways/123456789012345678/settings`}</Terminal>
...
<Terminal>{`curl -X PATCH \
  ...
  http://localhost:3000/api/giveaways/123456789012345678/settings`}</Terminal>
...
<CardContainer><Card href="https://github.com/AdityaTel89/robojs-giveaways/issues" title="GitHub Issues" description=""/>
<Card href="https://robojs.dev/discord" title="Robo.js Discord" description=""/>
<Card href="https://robojs.dev" title="Documentation" description=""/></CardContainer>
...
<CardContainer><Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/@robojs/giveaways" title="🔗 GitHub Repository" description="Explore source code on GitHub."/><Card href="/ref/framework" title="🔗 API Reference" description="Check out the entire API."/></CardContainer>
