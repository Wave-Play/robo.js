...
<Terminal execute>{`robo add @robojs/auth`}</Terminal>
...
<CardContainer><Card href="https://github.com/Wave-Play/robo.js/tree/main/packages/@robojs/auth" title="🔗 GitHub Repository" description="Explore source code on GitHub."/><Card href="/ref/framework" title="🔗 API Reference" description="Check out the entire API."/></CardContainer>
