  ...
  <Folder name="config" defaultOpen disabled>
    <Folder name="plugins" defaultOpen>
      <Folder name="robojs" defaultOpen>
        <File name="server.ts" note="Server plugin config" />
        <File name="sync.ts" note="Sync plugin config" />
        <File name="patch.ts" note="Patch plugin config" />
      </Folder>
    </Folder>
    <File name="robo.mjs" note="Main config" />
    <File name="vite.mjs" note="Vite config" />
  </Folder>
  <File name=".env" note="Secrets" />
</Files>
