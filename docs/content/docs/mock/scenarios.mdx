...
<Callout type="warn">
Scenarios are an advanced feature. If you are just getting started with testing, begin with [Stage UI](./stage-ui) for interactive testing or [Automated Testing](./automated-testing) for Jest-based tests.
</Callout>
