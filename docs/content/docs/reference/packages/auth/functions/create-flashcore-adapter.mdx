...
namespaces. Supports the full [PasswordAdapter](../interfaces/password-adapter) contract including
helper utilities such as [listUserIds](list-user-ids) and [listUsers](list-users) for admin
tooling.
