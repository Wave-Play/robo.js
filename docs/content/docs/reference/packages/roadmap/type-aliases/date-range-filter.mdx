...
| ------ | ------ | ------ |
| <a id="datefield"></a> `dateField`? | `"created"` \| `"updated"` | Which date field to filter on. Defaults to 'updated' if not specified. |
| <a id="enddate"></a> `endDate`? | `Date` \| `string` | The end of the date range (inclusive). Accepts both Date objects and ISO 8601 strings (e.g., '2025-01-31'). |
| <a id="startdate"></a> `startDate`? | `Date` \| `string` | The beginning of the date range (inclusive). Accepts both Date objects and ISO 8601 strings (e.g., '2025-01-01'). |
