...
<Files>
  <Folder name="src" defaultOpen disabled>
    ...
    <Folder name="events" defaultOpen>
      <Folder name="_start" defaultOpen>
...
Send a message when users level up. The plugin seeds a starter template at `seed/events/_start/level-announcements.ts` with rich embeds and customization options.
...
<Tabs items={["TypeScript", "JavaScript"]} groupId="language" persist>
  <Tab value="TypeScript">
    ```ts title="src/events/_start/xp-analytics.ts"
  ...
  <Tab value="JavaScript">
    ```js title="src/events/_start/xp-analytics.js"
    import { events, XP } from '@robojs/xp'
    import { logger } from 'robo.js'
...
<Tabs items={["TypeScript", "JavaScript"]} groupId="language" persist>
  <Tab value="TypeScript">
    ```ts title="src/events/_start/custom-rewards.ts"
    import { events } from '@robojs/xp'
    import { client } from 'robo.js'
  ...
  <Tab value="JavaScript">
    ```js title="src/events/_start/custom-rewards.js"
    import { events } from '@robojs/xp'
    import { client } from 'robo.js'
