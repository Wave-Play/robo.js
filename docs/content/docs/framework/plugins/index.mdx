...
Robo Plugins let you add features to your Robo with one command and integrate seamlessly thanks to the **[Robo File Structure](../core/file-structure)**. Anyone can **[create a plugin](./create)**.
