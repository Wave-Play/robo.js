...
When you install a plugin with the **[Robo CLI](/docs/robo-cli/robo)**, you may be prompted to include recommended files:
...
<Files>
  <Folder name="seed" defaultOpen disabled>
    <Folder name="_root" defaultOpen note="Copies to project root">
      <File name="index.html" />
    </Folder>
    <Folder name="api" defaultOpen note="Copies to src/api/">
      <File name="hello.ts" />
    </Folder>
  </Folder>
</Files>
