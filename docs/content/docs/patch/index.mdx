...
**What it does**: On Robo startup, checks whether the entry point command exists. If missing, automatically registers it via the Discord API. This runs as a `_start` lifecycle event -- no manual invocation needed.
