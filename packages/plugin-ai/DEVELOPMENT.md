...
```bash
npm install /path/to/plugin-ai
```

Replace `/path/to/plugin-ai` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `npm run build` command.
