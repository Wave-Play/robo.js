...
```bash
npx robo add /path/to/@robojs/roadmap
```

Replace `/path/to/@robojs/roadmap` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
