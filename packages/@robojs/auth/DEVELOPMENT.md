...
```bash
npx robo add /path/to/@robojs/auth
```

Replace `/path/to/@robojs/auth` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
