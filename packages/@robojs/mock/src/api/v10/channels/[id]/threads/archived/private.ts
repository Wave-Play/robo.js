...
export const GET = define(
	{
		...
		description: 'Returns archived threads in the channel that are private. Requires MANAGE_THREADS permission.',
		tags: ['Threads'],
		params: z.object({
			id: z.string().describe('The channel ID (Snowflake)')
		}),
		query: z.object({
			before: z.string().optional().describe('Returns threads archived before this ISO8601 timestamp'),
