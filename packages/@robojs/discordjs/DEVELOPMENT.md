...
```bash
npx robo add /path/to/@robojs/discordjs
```

Replace `/path/to/@robojs/discordjs` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
